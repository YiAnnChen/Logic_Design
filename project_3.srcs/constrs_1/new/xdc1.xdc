...
create_clock -add -name sys_clk_pin -period 80 -waveform {0 40} [get_ports { clk }];
...
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { led_1[0]  }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { led_1[0] }]; #IO_L16P_T2_35 Sch=led4_g
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { led_1[0] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led_1[1]}]; #IO_0_35 Sch=led5_b
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { led_1[1] }]; #IO_L22P_T3_AD7P_35 Sch=led5_g
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { led_1[1]}]; #IO_L23N_T3_35 Sch=led5_r

##LEDs

set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { led_2[0] }]; #IO_L6N_T0_VREF_34 Sch=led[0]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { led_2[1] }]; #IO_L6P_T0_34 Sch=led[1]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { led_2[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { led_2[3] }]; #IO_L23P_T3_35 Sch=led[3]
...
#set_property -dict { PACKAGE_PIN Y13   IOSTANDARD LVCMOS18 } [get_ports { choose[1]}]; #IO_L20N_T3_13 Sch=a
...
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS18 } [get_ports { choose[0] }]; #IO_L21P_T3_DQS_13 Sch=a[3]
...
#set_property -dict { PACKAGE_PIN V10  IOSTANDARD LVCMOS18 } [get_ports { data_in[2]}]; #IO_L19P_T3_35 Sch=sck
#set_property -dict { PACKAGE_PIN V6  IOSTANDARD LVCMOS18 } [get_ports { data_in[1]}]; #IO_L19P_T3_35 Sch=sck
#set_property -dict { PACKAGE_PIN W6  IOSTANDARD LVCMOS18 } [get_ports { data_in[0]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN U10  IOSTANDARD LVCMOS18 } [get_ports { on_fire[1]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN Y7  IOSTANDARD LVCMOS18 } [get_ports { on_fire[0]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN Y6  IOSTANDARD LVCMOS18 } [get_ports { pass_div[2]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN Y9  IOSTANDARD LVCMOS18 } [get_ports { pass_div[1]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN Y8  IOSTANDARD LVCMOS18 } [get_ports { pass_div[0]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN V7  IOSTANDARD LVCMOS18 } [get_ports { sad[1]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN T9  IOSTANDARD LVCMOS18 } [get_ports { sad[0]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN V8  IOSTANDARD LVCMOS18 } [get_ports { score[9]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN W8  IOSTANDARD LVCMOS18 } [get_ports { score[8]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN W10  IOSTANDARD LVCMOS18 } [get_ports { score[7]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN W9  IOSTANDARD LVCMOS18 } [get_ports { score[6]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN U9  IOSTANDARD LVCMOS18 } [get_ports { score[5]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN U8  IOSTANDARD LVCMOS18 } [get_ports { score[4]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN W11  IOSTANDARD LVCMOS18 } [get_ports { score[3]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN Y11  IOSTANDARD LVCMOS18 } [get_ports { score[2]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN T5  IOSTANDARD LVCMOS18 } [get_ports { score[1]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN U5  IOSTANDARD LVCMOS18 } [get_ports { score[0]}]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN U7  IOSTANDARD LVCMOS18 } [get_ports { fail }]; #IO_L19P_T3_35 Sch=sck
set_property -dict { PACKAGE_PIN Y12  IOSTANDARD LVCMOS18 } [get_ports { rst }]; #IO_L19P_T3_35 Sch=sck